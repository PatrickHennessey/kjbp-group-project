  ...
  legend.onAdd = function (map) 
      {
        ...
        if ( display_this== 6 || display_this == 10 || display_this== 8 || display_this == 9 )  {  colorz = [55,50,45,40,35,30,25,20,10];}
          ...
          if ( display_this == 0 ) { div.innerHTML += '<h4> GDP in Thousands of Millions of USD</h4>';}
          if ( display_this == 1 ) { div.innerHTML += '<h4> Population in the Millions</h4>';}
          if ( display_this == 2 ) { div.innerHTML += '<h4> World Rank (Lower is Better) </h4>';}
          if ( display_this == 3 ) { div.innerHTML += '<h4> Government Integrity (Higher is Better) </h4>';}
          if ( display_this == 4 ) { div.innerHTML += '<h4> Judicial Effectiveness (Higher is Better)  </h4>';}
          if ( display_this == 5 ) { div.innerHTML += '<h4> Fiscal Health (Higher is Better) </h4>';}
          if ( display_this == 6 ) { div.innerHTML += '<h4> Inflation   </h4>';}
          if ( display_this == 7 ) { div.innerHTML += '<h4> Public Debt of GDP   </h4>';}
          if ( display_this == 8 ) { div.innerHTML += '<h4> Avg Income Tax Rate   </h4>';}
          if ( display_this == 9 ) { div.innerHTML += '<h4> Avg Corporate Tax Rate   </h4>';}
          if ( display_this == 10 ){ div.innerHTML += '<h4> Unemployement </h4>';}
 ...
 if (displayInfo) { mymap.removeLayer(displayInfo)  ;}
  ...
  displayInfo.update = function (props) //, meta)//,db_data) /// Passes properties of hovered upon country and displays it in the control
          { 
            ...
            this._div.innerHTML = '<h2>Economics of the Globe</h2>' + (props ?
